...
/*  Author: 北辰
    日期: 31/01/2020
    功能: 创建一个解析类ParseHibernateAnnotation ，获取Hero类上配置的注解信息
    思路如下：
1. 首先获取Hero.class类对象
    ...
    public static void main(String[] args) {
        ...
        if(null==myEntity){
            ...
            if(null!=primaryKeyMethod){
                ...
                System.out.println("对应数据库中的字段是: "+myColumn);
            }
            ...
            for(Method m:methods){
                ...
                if(null==myColumn)
                    continue;
                System.out.format("属性: %s\t对应的数据库字段是:%s%n",method2attribute(m.getName()),
                        myColumn.value());
            }
        }
    }
