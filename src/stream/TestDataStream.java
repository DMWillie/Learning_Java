...
/*  Author: 北辰
    日期: 23/11/2019
    功能: 使用数据流的writeUTF()和readUTF() 可以进行数据的格式化顺序读写
如本例，通过DataOutputStream 向文件顺序写出 布尔值，整数和字符串。 然后再通过DataInputStream
顺序读入这些数据。
...
public class TestDataStream {
    ...
    private static void read(){
        File f = new File("d:/Learning_Java/src/data/lol4.txt");
        try(
